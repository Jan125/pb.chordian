...
Macro RenderBody()
  ...
  ;line1
  SaveVectorState()
  AddPathBox(0+0.5, 0+0.5, 226-1, 151-1)
  ClipPath()
  BodyLines()
  ...
  ;line2
  SaveVectorState()
  AddPathBox(0+0.5, 154+0.5, 226-1, 97-1)
  ClipPath()
  BodyLines()
  VectorSourceColor(RGBA(137, 138, 127, 255))
  StrokePath(1.0)
  ...
  ;line3
  SaveVectorState()
  AddPathBox(0+0.5, 254+0.5, 226-1, 127-1)
  ClipPath()
  BodyLines()
  VectorSourceColor(RGBA(137, 138, 127, 255))
  StrokePath(1.0)
  ...
  ;line4
  SaveVectorState()
  AddPathBox(0+0.5, 384+0.5, 226-1, 215-1)
  ClipPath()
  BodyLines()
  VectorSourceColor(RGBA(137, 138, 127, 255))
  StrokePath(1.0)
  ...
  ;line5
  SaveVectorState()
  AddPathBox(229+0.5, 0+0.5, 441-1, 600-1)
  ClipPath()
  BodyLines()
  VectorSourceColor(RGBA(137, 138, 127, 255))
  StrokePath(1.0)
  ...
  ;line6
  SaveVectorState()
  AddPathBox(673+0.5, 0+0.5, 107-1, 600-1)
  ClipPath()
  BodyLines()
  VectorSourceColor(RGBA(137, 138, 127, 255))
  StrokePath(1.0)
  ...
  BodyLines()
  ClipPath()
  AddPathBox(673+1, 0+1, 107-2, 600-2)
  VectorSourceColor(RGBA(137, 138, 127, 255))
  StrokePath(1.0)
  RestoreVectorState()
  ...
  ;line7
  SaveVectorState()
  AddPathBox(783+0.5, 0+0.5, 20-1, 600-1)
  ClipPath()
  BodyLines()
  VectorSourceColor(RGBA(137, 138, 127, 255))
  StrokePath(1.0)
...
If StartVectorDrawing(SvgVectorOutput("knob_hole.svg", 43, 43, #PB_Unit_Pixel))
  ...
  StopVectorDrawing()
EndIf
CreateImage(0, 43*#INTERNALSCALE, 43*#INTERNALSCALE, 32, TRANSPARENTCOLOR)
If StartDrawing(ImageOutput(0))
  DrawingMode(#PB_2DDrawing_AlphaChannel)
  Box(0, 0, OutputWidth(), OutputHeight(), RGBA(0, 0, 0, 0))
  StopDrawing()
...
If StartVectorDrawing(ImageVectorOutput(0, #PB_Unit_Pixel))
  ...
  FillPath()
  StopVectorDrawing()
  ResizeImage(0, 43*#EXPORTSCALE, 43*#EXPORTSCALE)
...
If StartVectorDrawing(SvgVectorOutput("knob_small.svg", 27, 27, #PB_Unit_Pixel))
  ...
  StopVectorDrawing()
EndIf
CreateImage(0, 27*#INTERNALSCALE, 27*#INTERNALSCALE, 32, TRANSPARENTCOLOR)
If StartDrawing(ImageOutput(0))
  DrawingMode(#PB_2DDrawing_AlphaChannel)
  Box(0, 0, OutputWidth(), OutputHeight(), RGBA(0, 0, 0, 0))
  StopDrawing()
...
If StartVectorDrawing(ImageVectorOutput(0, #PB_Unit_Pixel))
  ...
  FillPath()
  StopVectorDrawing()
  ResizeImage(0, 27*#EXPORTSCALE, 27*#EXPORTSCALE)
...
If StartVectorDrawing(SvgVectorOutput("led_on.svg", 6, 6, #PB_Unit_Pixel))
  ...
  StopVectorDrawing()
EndIf
CreateImage(0, 6*#INTERNALSCALE, 6*#INTERNALSCALE, 32, TRANSPARENTCOLOR)
If StartDrawing(ImageOutput(0))
  DrawingMode(#PB_2DDrawing_AlphaChannel)
  Box(0, 0, OutputWidth(), OutputHeight(), RGBA(0, 0, 0, 0))
  StopDrawing()
...
If StartVectorDrawing(ImageVectorOutput(0, #PB_Unit_Pixel))
  ...
  FillPath()
  StopVectorDrawing()
  ResizeImage(0, 6*#EXPORTSCALE, 6*#EXPORTSCALE)
...
If StartVectorDrawing(SvgVectorOutput("base.svg", 800, 600, #PB_Unit_Pixel))
  ...
  StopVectorDrawing()
EndIf
CreateImage(0, 800*#INTERNALSCALE, 600*#INTERNALSCALE, 32, TRANSPARENTCOLOR)
If StartDrawing(ImageOutput(0))
  DrawingMode(#PB_2DDrawing_AlphaChannel)
  Box(0, 0, OutputWidth(), OutputHeight(), RGBA(0, 0, 0, 0))
  StopDrawing()
...
If StartVectorDrawing(ImageVectorOutput(0, #PB_Unit_Pixel))
  ...
  StopVectorDrawing()
  ResizeImage(0, 800*#EXPORTSCALE, 600*#EXPORTSCALE)
