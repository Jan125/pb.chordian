...
If InitSound()
  ...
  ;-Play all sounds.
  PlaySound(#Snd_BassNorm, #PB_Sound_Loop, 20)
  PlaySound(#Snd_BassHigh, #PB_Sound_Loop, 0)
  PlaySound(#Snd_Chord1, #PB_Sound_Loop, 20)
  PlaySound(#Snd_Chord2, #PB_Sound_Loop, 20)
  PlaySound(#Snd_Chord3, #PB_Sound_Loop, 20)
